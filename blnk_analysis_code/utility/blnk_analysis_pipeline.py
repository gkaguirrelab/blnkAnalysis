...
# We will make one more verification function that asserts all 
# paths exist, are local, coincide with subject id, and so does the output 
def verify_output(sid: str, o_path: str, v_paths: list[str]) -> None:
    ...
    # Now assert video paths exist and also 
    # that they are local 
